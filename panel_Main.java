...
public class panel_Main extends JPanel implements ActionListener{
	...
	private void mainAct(int X, int Y, int sTime) {   // sTime은 1000단위로 줄것
		if(Manager.manager.mainOn==true) {
			if (size>=sTime) {
				if(size <sTime+1000) {
